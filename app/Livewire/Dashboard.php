...
class Dashboard extends Component
{
    ...
    {
        $this->partners = collect()->merge(Restaurante::all())->merge(TurismoNautico::all())->merge(GuiaDeTurismo::all())->merge(CentroDeConvencoes::all())->merge(CasaDeEspetaculos::all())->merge(AcampamentoTuristico::all())->merge(LocadoraDeVeiculosParaTuristas::all())->merge(AgenciasDeTurismo::all())->merge(ParqueAquaticoEEmpreendimentoDeLazer::all()->merge(ParqueTematico::all())->merge(MeioDeHospedagem::all()));
    }
