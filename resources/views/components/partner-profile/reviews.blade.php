<div class="lg:flex lg:flex-col flex flex-row">
  <div class="lg:border-y border-primary py-4 lg:w-full w-1/2">
    <div class="lg:h-72 h-48 bg-cover bg-no-repeat bg-center" style="background-image: url('{{ asset('images/dev-photo-1.jpg') }}')"></div>
  </div>
