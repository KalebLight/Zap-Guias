<div>
  @if ($isOpen)
    ...
    <!-- Modal Container -->
    <div class="relative flex flex-col w-full max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden" style="max-height: calc(100vh - 144px); margin-top: 32px; margin-bottom: 32px;">
      <!-- Close Button -->
      ...
      <div class="mb-4">
        ...
        <input type="tel" placeholder="WhatsApp" wire:model="whatsapp" class="w-full rounded-full border border-primary text-primary h-8 mt-2 placeholder:text-primary placeholder:opacity-60" x-mask="+55 (99) 99999-9999">
